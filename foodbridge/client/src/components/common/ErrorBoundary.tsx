    ...
    if (this.state.hasError) {
      return (
        <div style={{padding:24,fontFamily:'Inter, sans-serif',color:'#111827'}}>
          ...
          <p style={{color:'var(--text-secondary)'}}>An exception occurred while rendering the app. See the developer console for details.</p>
          <div style={{marginTop:12,background:'var(--bg-primary)',padding:12,borderRadius:8,border:'1px solid #E6EAF0'}}>
            <strong>Error:</strong>
